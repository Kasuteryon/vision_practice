...
def run():
    ...
    result_canny = cv2.dilate(canny, kernel, iterations=10)
    ...
    result_sobel = cv2.dilate(sobel, kernel, iterations=1)
    # ----------------------------------------------------------------------------
    ...
    result_prewitt = cv2.dilate(filtered_prewitt_image, kernel, iterations=1)
